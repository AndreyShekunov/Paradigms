...
print(normalize([1, 5, 3, 4, 8, 10]))
# [0.0, 0.4444444444444444, 0.2222222222222222, 0.3333333333333333, 0.7777777777777778, 1.0]
...
# подается массив, где могут присутствовать дубликаты (а могут и не присутствовать). 
